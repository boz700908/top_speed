    ...
    internal static partial class Spec
    {
        public static Common FromCustom(CustomVehicleTsvData parsed, TrackWeather weather)
        {
            return new Common
            {
                ...
                AirDensityKgPerM3 = parsed.AirDensityKgPerM3,
                RollingResistanceSpeedGainPerMps = parsed.RollingResistanceSpeedGainPerMps,
                DrivelineCoastTorqueNm = parsed.DrivelineCoastTorqueNm,
                DrivelineCoastViscousNmPerRadS = parsed.DrivelineCoastViscousNmPerRadS,
                CoastStopSpeedKph = parsed.CoastStopSpeedKph,
                CoastStopDecelKphps = parsed.CoastStopDecelKphps,
                ...
                PhysicsModel = parsed.PhysicsModel,
                EngineFrictionCoulombNm = parsed.EngineFrictionCoulombNm,
                EngineFrictionViscousNmPerRadS = parsed.EngineFrictionViscousNmPerRadS,
                EnginePumpingLossNmAtClosedThrottle = parsed.EnginePumpingLossNmAtClosedThrottle,
                EngineAccessoryTorqueNm = parsed.EngineAccessoryTorqueNm,
                IdleTargetRpm = parsed.IdleTargetRpm,
                IdleMaxCorrectionTorqueNm = parsed.IdleMaxCorrectionTorqueNm,
                IdleControlKp = parsed.IdleControlKp,
                IdleControlKi = parsed.IdleControlKi,
                ClutchCapacityNm = parsed.ClutchCapacityNm,
                ClutchEngageRatePerS = parsed.ClutchEngageRatePerS,
                ClutchReleaseRatePerS = parsed.ClutchReleaseRatePerS,
                ClutchDragTorqueNm = parsed.ClutchDragTorqueNm,
                LaunchTargetSlipRpm = parsed.LaunchTargetSlipRpm,
