...
namespace TopSpeed.Vehicles.Loader
{
    internal static partial class Spec
    {
        public static void Apply(VehicleDefinition def, Common spec)
        {
            ...
            def.AirDensityKgPerM3 = spec.AirDensityKgPerM3;
            def.RollingResistanceSpeedGainPerMps = spec.RollingResistanceSpeedGainPerMps;
            def.DrivelineCoastTorqueNm = spec.DrivelineCoastTorqueNm;
            def.DrivelineCoastViscousNmPerRadS = spec.DrivelineCoastViscousNmPerRadS;
            def.CoastStopSpeedKph = spec.CoastStopSpeedKph;
            def.CoastStopDecelKphps = spec.CoastStopDecelKphps;
            ...
            def.PhysicsModel = spec.PhysicsModel;
            def.EngineFrictionCoulombNm = spec.EngineFrictionCoulombNm;
            def.EngineFrictionViscousNmPerRadS = spec.EngineFrictionViscousNmPerRadS;
            def.EnginePumpingLossNmAtClosedThrottle = spec.EnginePumpingLossNmAtClosedThrottle;
            def.EngineAccessoryTorqueNm = spec.EngineAccessoryTorqueNm;
            def.IdleTargetRpm = spec.IdleTargetRpm;
            def.IdleMaxCorrectionTorqueNm = spec.IdleMaxCorrectionTorqueNm;
            def.IdleControlKp = spec.IdleControlKp;
            def.IdleControlKi = spec.IdleControlKi;
            def.ClutchCapacityNm = spec.ClutchCapacityNm;
            def.ClutchEngageRatePerS = spec.ClutchEngageRatePerS;
            def.ClutchReleaseRatePerS = spec.ClutchReleaseRatePerS;
            def.ClutchDragTorqueNm = spec.ClutchDragTorqueNm;
            def.LaunchTargetSlipRpm = spec.LaunchTargetSlipRpm;
